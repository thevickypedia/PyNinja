...
from init import urljoin, NINJA_API_URL, CHUNK_SIZE, SESSION
...
async def download_large_file(
    ...
    Args:
        ...
        chunk_size: Size of each chunk to read. Defaults to 8192 bytes.
    """
    ...
    if filepath:
        ...
        destination = os.path.join(destination or pathlib.Path(__file__).parent, os.path.basename(directory) + ".zip")
