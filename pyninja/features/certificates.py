...
def parse_certificate_output(output: str, raw: bool, include_path: bool) -> Generator[models.Certificate]:
...
def get_all_certificates(raw: bool = False, include_path: bool = True) -> models.CertificateStatus:
    ...
    try:
        ...
        if all_certificates := list(parse_certificate_output(output, raw, include_path)):
